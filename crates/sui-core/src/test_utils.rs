...
use sui_types::messages::GAS_UNIT_FOR_OBJECT_BASICS;
use sui_types::messages::{
    CallArg, SignedTransaction, TransactionData, VerifiedTransaction, DUMMY_GAS_PRICE,
    GAS_UNIT_FOR_TRANSFER,
};
...
pub fn make_transfer_object_move_transaction(
    ...
    to_sender_signed_transaction(
        TransactionData::new_move_call(
            ...
            gas_object_ref,
            args,
            GAS_UNIT_FOR_OBJECT_BASICS * gas_price,
            gas_price,
        )
        .unwrap(),
        keypair,
